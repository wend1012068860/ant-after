...
public class LunarCalendar {
    ...
    public static final int[] lunarToSolar(int year, int month, int monthDay, boolean isLeapMonth) {
        ...
        if (year < MIN_YEAR || year > MAX_YEAR || month < 1 || month > 12
            ...
            throw new IllegalArgumentException(
                    "Illegal lunar date, must be like that:nt" +
                            "year : 1900~2099nt" +
                            "month : 1~12nt" +
                            "day : 1~30");
        }
    ...
    public static void main(String[] args) {
        System.out.println("农历：" + Arrays.toString(solarToLunar(2023, 1, 5)));

        System.out.println("公历：" + Arrays.toString(lunarToSolar(2023, 1, 24, false)));
    }
